...
namespace DevExpress.Xpf.LayoutControlDemo
{
    ...
    //        AllowCustomization="{Binding ElementName=root, Path=IsPopupContentInvisible, 
    ...
    public class LayoutControlCustomizationBehavior : Behavior<DataLayoutControl>
    {
        ...
        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register("SelectedItem", typeof(FrameworkElement), 
                typeof(LayoutControlCustomizationBehavior),
                new PropertyMetadata(null, new PropertyChangedCallback(SelectedChanged)));
                // new PropertyMetadata(null));
        static void SelectedChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((LayoutControlCustomizationBehavior)d).OnSelectedChanged();
        }
        ...
        public static readonly DependencyProperty AllowCustomizationProperty =
            DependencyProperty.Register("AllowCustomization", typeof(bool), typeof(LayoutControlCustomizationBehavior), 
                new PropertyMetadata(true, new PropertyChangedCallback(AllowCustomizationChanged)));
